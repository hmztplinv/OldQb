...
$(function () {
 ...
 tables = {
     ...
     allOrders: {
         lengthChange: false,
         buttons: ["copy", "excel", "pdf", "print"],
         wrapper: "#todolist_wrapper .col-md-6:eq(0)",
         scrollX: true,
         pageLength: 3,
     },
     Customers: {
         lengthChange: false,
         buttons: ["copy", "excel", "pdf", "print"],
         wrapper: "#Customers_wrapper .col-md-6:eq(0)",
         scrollX: true,
         pageLength: 3,
     },
     Booking: {
         lengthChange: false,
         buttons: ["copy", "excel", "pdf", "print"],
         wrapper: "#Booking_wrapper .col-md-6:eq(0)",
         scrollX: true,
         pageLength: 3,
     },
     OfferFreights: {
         lengthChange: false,
         buttons: ["copy", "excel", "pdf", "print"],
         wrapper: "#OfferFreights_wrapper .col-md-6:eq(0)",
         scrollX: true,
         pageLength: 3,
     },
     orders: {
    ...
    commingshippings: {
      lengthChange: false,
      buttons: ["copy", "excel", "pdf", "print"],
      wrapper: "#commingshippings_wrapper .col-md-6:eq(0)",
      scrollX: true,
      pageLength: 3,
    },
    Orders: {

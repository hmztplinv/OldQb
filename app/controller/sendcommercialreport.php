...
$pdf->Cell(153, 10, "DESTINATION", 0, 3, 'R');


$image_file = 'public/images/qua.png';
$pdf->Image($image_file, 13, 13, 80, '', 'PNG', '', 'T', false, 60, 'L', false, false, 0, false, false, false);

$pdf->Ln();
$pdf->SetFont('dejavusans', 'B', 16);
$pdf->Cell(300, 63, "COMMERCIAL INVOICE", 0, 3, 'L');
...
$pdf->MultiCell(30, 20, $txt6, 1, 'L', 1, 2, 15, 100, true);
...
$pdf->MultiCell(60, 8, $txt1, 1, 'R', 1, 2, 140, 85, true);
$pdf->Ln();
$pdf->SetFont('helvetica', '', 8);
$pdf->Ln(10);
$txt7 = " 3X20\n GEMLIK-TORONTO";

$pdf->MultiCell(60, 10, $txt7, 1, 'R', 1, 2, 140, 100, true);
$pdf->Ln(40);
...
$attachment = $pdf->Output(__DIR__.'../../public/docs/file.pdf','F');

...
$countproduct=Products::get_product("count",$selectpage,get('origin'),get('collection'),get('size'),get('name'),get('cins'),get('thickness'),get('surface'),get('reclap'),get('matParlak'),get('color'),get('quality'));
$pageproductcount=count($countproduct)/9;
$productsfeatures=Products::get_product("general",$selectpage,get('origin'),get('collection'),get('size'),get('name'),get('cins'),get('thickness'),get('surface'),get('reclap'),get('matParlak'),get('color'),get('quality'));

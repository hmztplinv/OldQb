...
<div class="sidebar sidebar-right sidebar-animate">
    <div class="sidebar-icon">
        <a
                ...
                class="text-end float-end text-dark fs-20"
    ...
    <div class="sidebar-body">
        ...
        <div class="d-flex p-3">
            ...
            ><input checked type="checkbox" /><span
                >Hangout With friends</span
                ></label
            >
            <span class="ms-auto">
              <i
                      class="fe fe-edit-2 text-primary me-2"
              ...
              ></i>
              <i
                      class="fe fe-trash-2 text-danger me-2"
                      data-bs-toggle="tooltip"
                      title=""
                      data-bs-placement="top"
        ...
        <div class="d-flex p-3 border-top">
            <label class="ckbox"
            ><input type="checkbox" /><span>Do something more</span></label
            >
            <span class="ms-auto">
              <i
                      class="fe fe-edit-2 text-primary me-2"
        ...
        <div class="d-flex p-3 border-top">
            <label class="ckbox"
            ><input type="checkbox" /><span>System Updated</span></label
            >
            <span class="ms-auto">
              <i
                      class="fe fe-edit-2 text-primary me-2"
        ...
        <div class="d-flex p-3 border-top">
            <label class="ckbox"
            ><input type="checkbox" /><span>Find an Idea</span></label
            >
            <span class="ms-auto">
              <i
                      class="fe fe-edit-2 text-primary me-2"
        ...
        <div class="d-flex p-3 border-top mb-0">
            <label class="ckbox"
            ><input type="checkbox" /><span>Project review</span></label
            >
            <span class="ms-auto">
              <i
                      class="fe fe-edit-2 text-primary me-2"
            ...
            <div class="main-traffic-detail-item">
                ...
                <div class="progress">
                    <div
                            ...
                            aria-valuemin="0"
                            aria-valuenow="20"
                            class="progress-bar progress-bar-xs wd-20p"
                            role="progressbar"
                    ></div>
                </div>
                <!-- progress -->
            ...
            <div class="main-traffic-detail-item">
                ...
                <div class="progress">
                    <div
                            ...
                            aria-valuemin="0"
                            aria-valuenow="15"
                            class="progress-bar progress-bar-xs bg-secondary wd-15p"
                            role="progressbar"
                    ></div>
                </div>
                <!-- progress -->
            ...
            <div class="main-traffic-detail-item">
                ...
                <div class="progress">
                    <div
                            ...
                            aria-valuemin="0"
                            aria-valuenow="45"
                            class="progress-bar progress-bar-xs bg-success wd-45p"
                            role="progressbar"
                    ></div>
                </div>
                <!-- progress -->
            ...
            <div class="main-traffic-detail-item">
                ...
                <div class="progress">
                    <div
                            ...
                            aria-valuemin="0"
                            aria-valuenow="25"
                            class="progress-bar progress-bar-xs bg-info wd-25p"
                            role="progressbar"
                    ></div>
                </div>
                <!-- progress -->
            ...
            <div class="main-traffic-detail-item">
                ...
                <div class="progress">
                    <div
                            ...
                            aria-valuemin="0"
                            aria-valuenow="25"
                            class="progress-bar progress-bar-xs bg-danger wd-25p"
                            role="progressbar"
                    ></div>
                </div>
                <!-- progress -->
...
<!-- Circle Progress js-->
<script src="<?=public_url('js/circle-progress.min.js')?>"></script>
<script src="<?=public_url('js/chart-circle.js')?>"></script>
...
<!-- Multislider js -->
<script src="<?=public_url('plugins/multislider/multislider.js')?>"></script>
<script src="<?=public_url('js/carousel.js')?>"></script>
...
<script>// Loader gizleme fonksiyonu
    function hideLoader() {
    ...
    // F5 (yenileme) tuşuna basıldığında loader'ı göster
...
<script>
    $('.deletecart').click(function (e) {
        var id = $(this).data('id');
        var idToSend = { delete_cart: id };


        $.post("<?= customer_url('new_order') ?>", idToSend, function (result) {

                        ...
                        <div class="card  ">
                            ...
                            <div class="p-5 mt-5">
                                <ul class="nav nav-tabs ">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link active" aria-current="page" href="deleted_orders"><p class="text-dark"><b>Deleted Order</b></p></a>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <table id="example" class="display" style="width:100%">
                                        ...
                                        for($i=0;$i<count($deletedcarts);$i++):
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $deletedcarts[$i]['collection']?></td>
                                                <td><?= $deletedcarts[$i]['size']==NULL?'no info':$deletedcarts[$i]['size']?></td>
                                                <td><?= $deletedcarts[$i]['surface']==NULL?'no info':$deletedcarts[$i]['surface']?></td>
                                                <td><?= $deletedcarts[$i]['color']==NULL?'no info':$deletedcarts[$i]['color']?></td>
                                                <td><?= $deletedcarts[$i]['quantity']  ?></td>
                                            </tr>
                                        <?php endfor;?>
                                        </tbody>
                                    </table>
                    ...
                    <script>
                        ...
                        var example=  $('#example').DataTable( {
                            ...
                            buttons: [
                                ...
                                {
                                    extend: 'pdfHtml5',
                                    title: 'Deleted_Orders'}, 'copy', 'print',
                            ],
                            responsive: {
                                details: false
                            }

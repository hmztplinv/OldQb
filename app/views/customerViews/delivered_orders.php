                        ...
                        <div class="card  ">
                            ...
                            <div class="p-5 mt-5">
                                <ul class="nav nav-tabs ">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link active" aria-current="page" href="delivered_orders"><p class="text-dark"><b>Delivered Order</b></p></a>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <table id="example" class="display" style="width:100%">
                                        ...
                                        for($i=0;$i<count($orders);$i++):
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $orders[$i]['applicationarea']  ?></td>
                                                <td><?= $orders[$i]['size']  ?></td>
                    ...
                    <script>
                          ...
                          var example=  $('#example').DataTable( {
                                ...
                                buttons: [
                                    ...
                                    {
                                        extend: 'pdfHtml5',
                                        title: 'Delivered_Orders'}, 'copy', 'print'
                                ],
                                responsive: {
                                    details: false
                                }

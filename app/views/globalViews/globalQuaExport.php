                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header card-header-border-bottom bg-white">
                                <h2>QUA EXPORT 20 DC </h2>

                            </div>
                            <div class="p-5 mt-5">
                                <ul class="nav nav-tabs animate__animated animate__fadeInDown">
                                    <a class="nav-link active" aria-current="page" href="globalQuaExport"><p class="text-dark"><b> Qua Export 20 DC</q></b></p></a>
                                    <li class="nav-item">
                                        <a class="nav-link" aria-current="page" href="globalQuaExportLcl"><p class="text-dark"><b>QUA EXPORT LCL</b></p></a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" aria-current="page" href="globalBienExport"><p class="text-dark"><b>BIEN EXPORT 20 DC</b></p></a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" aria-current="page" href="globalBienExportLcl"><p class="text-dark"><b>BIEN EXPORT LCL</b></p></a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" aria-current="page" href="globalQtileExport"><p class="text-dark"><b>QTILE EXPORT 20 DC</b></p></a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" aria-current="page" href="globalQtileExportLcl"><p class="text-dark"><b>QTILE EXPORT LCL</b></p></a>
                                    </li>
                                </ul>
                                <div class="table-responsive animate__animated animate__fadeInLeft">
                                    <table id="rejectedcostlist" class="display" style="width:100%">
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-custom" style="font-size: 10px;">OPERANSAYON REF</th>
                                            <th class="text-custom" style="font-size: 10px;">DATE</th>
                                            <th class="text-custom" style="font-size: 10px;">CONSIGNEE</th>
                                            ...
                                            <th class="text-custom" style="font-size: 10px;">ALIS NAVLUN + LOKAL</th>
                                            <th class="text-custom" style="font-size: 10px;">IC NAKLIYE</th>
                                            <th class="text-custom" style="font-size: 10px;">YDG</th>
                                            ...
                                            <th class="text-custom" style="font-size: 10px;">SATIS NAVLUN + LOKAL</th>
                                            <th class="text-custom" style="font-size: 10px;">NAVLUN KAR</th>
                                            <th class="text-custom" style="font-size: 10px;">LOKAL KAR</th>
                                            <th class="text-custom" style="font-size: 10px;">TOTAL KAR</th>
                                        </tr>
                                        </thead>
                                        <tbody>

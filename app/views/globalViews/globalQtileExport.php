                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header card-header-border-bottom bg-white">
                                <h2>QTILE EXPORT 20 DC </h2>

                            </div>
                            <div class="p-5 mt-5">
                                <ul class="nav nav-tabs animate__animated animate__fadeInDown">
                                    <a class="nav-link  " aria-current="page" href="globalQuaExport"><p class="text-dark"><b> Qua Export 20 DC</q></b></p></a>
                                    <li class="nav-item">
                                    ...
                                    <li class="nav-item  ">
                                        <a class="nav-link active" aria-current="page" href="globalQtileExport"><p class="text-dark"><b>QTILE EXPORT 20 DC</b></p></a>
                                    </li>
                                    <li class="nav-item">

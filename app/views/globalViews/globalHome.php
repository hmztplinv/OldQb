    ...
    <div class="main">
            ...
            <section id="main-content">
                <div class="row mt-5">
                    <div class="col-lg-4">
                        <div class="card animate__animated animate__fadeInLeft">
                            <div class="stat-widget-one">
                                <div class="stat-icon dib"><i class="mdi mdi-briefcase-download color-success border-success"></i>
                                </div>
                                <div class="stat-content dib">
                                    <div class="stat-text">Completed Shipping</div>
                    ...
                    <div class="col-lg-4">
                        <div class="card animate__animated animate__fadeInLeft">
                            <div class="stat-widget-one">
                                <div class="stat-icon dib"><i class="mdi mdi-briefcase-upload color-primary border-primary"></i>
                                </div>
                                <div class="stat-content dib">
                                    <div class="stat-text">Unaproved Shipping</div>
                    ...
                    <div class="col-lg-4">
                        <div class="card animate__animated animate__fadeInLeft">
                            <div class="stat-widget-one">
                                ...
                                <div class="stat-content dib">
                                    <div class="stat-text text-justify">Pending Freights </div>
                                    <div class="stat-digit text-danger">40</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-xl-6">
                        <div class="card animate__animated animate__fadeInLeft">
                            <div class="card-title  ">
                                <h3 style="text-align: center">Freight Gainfulness <select style="float: right;font-size: 19px ">
                            ...
                            <div class="sales-chart" style="height: 390px ">
                                <canvas id="team-chart" width="" height=""></canvas>
                            </div>
                            <div class="card-footer mt-4 bg-white">
                                <a href="<?=operation_url('navlun')?>" >Freight  PROFITABILITY REPORT</a>
                            </div>
                        </div>
                    </div>


                    <div   class="col-lg-6 col-xl- "Y4WQ" >
                    <div class="card animate__animated animate__fadeInLeft" id="activity-user">

                        <div class="card-title  ">
                            <h3 style="text-align: center">Shipping Number <select style="float: right;font-size: 19px ">
                                    <option>Afganistan</option>
                                    <option>Tr</option>
                                    <option>It</option>
                                    <option>Fr</option>
                        ...
                        <div class="card-body">
                            ...
                            <canvas id="currentUser" height="390px"></canvas>
                        </div>
                        <div class="card-footer mt-4 bg-white">
                            Total Shipping : 30.000
                        </div>
                    </div>
                </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="card animate__animated animate__fadeInLeft">
                    <div class="card-title">
                        <h3 style="text-shadow: 1px 1px #949494;" class="text-center">Goals</h3>
                    </div>
                    ...
                    <div class="card-body" activity-data-spacing="">
                        ...
                        <canvas id="activity" width="572" height="403" style="display: block; height: 400px; width: 458px;" class="chartjs-render-monitor"></canvas>
                    </div>
                </div>
            </div>
            <div class="col-lg-6"  >
                <div class="card animate__animated animate__fadeInLeft">
                    <div class="card-title">
                        <h3 style="text-shadow: 1px 1px #949494;" class="text-center">Yaklaşan Yüklemeler</h3>
                    </div>
                    <div class="row">
                        <div class="col-md-12" style="text-align: center"><h1>22.01.2023</h1> </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12" style="text-align: center"><h3   >QUA => (SV/AQJ =>TR/IZM
                                )</h3> </div>
                    </div>
          ...
          <table style="white-space: nowrap; width: 100%">
            <tr>
              ...
              <td style="text-align: right">
                <span class="btn-group">
                  <button class="js-cal-option btn btn-default {{: mode==='year'? 'active':'' }}" data-mode="year">Yıl</button>
                  <button class="js-cal-option btn btn-default {{: mode==='month'? 'active':'' }}" data-mode="month">Ay</button>
                  <button class="js-cal-option btn btn-default {{: mode==='week'? 'active':'' }}" data-mode="week">Hafta</button>
                  <button class="js-cal-option btn btn-default {{: mode==='day'? 'active':'' }}" data-mode="day">Gün</button>
                </span>
              </td>
            </tr>
          </table>

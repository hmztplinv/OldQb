                        ...
                        <div class="card  ">
                            ...
                            <div class="p-5 mt-5">
                                <ul class="nav nav-tabs ">
                                    <a class="nav-link active" aria-current="page" href="price_list"><p class="text-dark"><b>All Price List</b></p></a>
                                    <li class="nav-item">
                                        <a class="nav-link" aria-current="page" href="approved_price_list"><p class="text-dark"><b>Approved Price List</b></p></a>
                                    </li>
                                    <li class="nav-item">
                                ...
                                <div class="table-responsive">
                                    <form action="<?=seller_url('price_list')?>" method="post" >
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?=site_url('/seller/commercial_bien') ?>">
                                                    <button type="button" class="btn btn-outline-primary" data-mdb-ripple-color="dark" id="price_"style="background-color: #0a4966; color: white">Sent Commercial</button>
                                                </a>
                                                <!--
                                               ...
                                               -->
                                                <a href="<?=site_url('/seller/proforma_bien') ?>">
                                                    <button type="button" class="btn btn-outline-primary" data-mdb-ripple-color="dark"id="price_"style="background-color: #0a4966; color: white">Sent Proforma</button>
                                                </a>
                                                <!--
                                                ...
                                                -->
                                                       ...
                                                       <button name="approve" type="submit" value="<?= $item['orderId'] ?>" id="1" class="btn btn-outline-primary" style="background-color: #0a4966; color: white">Approve</button>

                        ...
                        <div class="card  ">
                            ...
                            <div class="p-5 mt-5">
                                <ul class="nav nav-tabs ">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link active " aria-current="page" href="receiving"><p class="text-dark"><b>Paid Receivables</b></p></a>
                                    </li>
                                </ul>
                                ...
                                <div class="table-responsive">
                                    <table id="example" class="display" style="width:100%">
                                        <thead>
                                        <tr>
                                            <th class="text-custom text-center">CompanyS</th>
                                            ...
                                            <th class="text-custom text-center">Tek Düzen //İngilizce Sorulcak</th>

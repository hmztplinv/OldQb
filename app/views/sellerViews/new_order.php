...
<div class="page">
                            ...
                            <div class="col-md-12 col-lg-12">
                                <div class="card custom-card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <a class="btn ripple btn-primary btn-block" href="<?= site_url('seller/new_order?page=').($selectpage) ?>">Reset</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-8 col-sm-6 col-lg-9 ">
                                        ...
                                        <div class="product-grid">
                                            ...
                                            <div class="product-image">
                                                ...
                                                <div class="product-link">
                                                    <a class="w-100" href="<?= seller_url('product_detail?id=').$item["id"].'&currency='.$item["currency"].'&origin='.$item["product_origin"]?>" onclick="copyURL('<?= site_url('product_detail?id=').$item["id"].'&currency='.$item["currency"].'&origin='.$item["product_origin"]?>')">
                                            ...
                                            <div class="product-content">
                                                ...
                                                <p><b>PRODUCTION DATE :</b> <?= date('Y-m-d', strtotime(Products::check_production_program_by_id($item['id']))) ?></p>
                        ...
                        <nav>
                            <ul class="pagination justify-content-end">
                                ...
                                } ?>"><a class="page-link <?php if($x==$selectpage){echo 'active';}?>" href="<?=site_url('seller/new_order?page=').$x?><?= get('origin')!='' ? '&origin='.get('origin'):''?><?= get('collection')!='' ? '&collection='.get('collection'):''?><?= get('size')!='' ? '&size='.get('size'):''?><?= get('name')!='' ? '&name='.get('name'):''?><?= get('cins')!='' ? '&cins='.get('cins'):''?><?= get('thickness')!='' ? '&thickness='.get('thickness'):''?><?= get('surface')!='' ? '&surface='.get('surface'):''?><?= get('reclap')!='' ? '&reclap='.get('reclap'):''?><?= get('matParlak')!='' ? '&matParlak='.get('matParlak'):''?><?= get('color')!='' ? '&color='.get('color'):''?><?= get('quality')!='' ? '&quality='.get('quality'):''?>"><?php echo $x?></a></li>
                                <?php endfor;?>
    ...
    <script>
        ...
        $('.addcart').click(function (e) {
            ...
            var dataToSend = { new_cart: id + ',' + price };

                        ...
                        <div class="card  ">
                            ...
                            <div class="p-5 mt-5">
                                <ul class="nav nav-tabs ">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link active" aria-current="page" href="unapproved_price_list"><p class="text-dark"><b>Unapproved Price List</b></p></a>
                                    </li>
                    ...
                    <script>
                        ...
                        var example=   $('#example').DataTable( {
                            ...
                            buttons: [{
                                ...
                                extend: 'excelHtml5',
                                title: 'Unapproved_Price_List'
                            },
                                {
                                    extend: 'pdfHtml5',
                                    title: 'Unapproved_Price_List'}, 'copy', 'print'
                            ],
                            responsive: {
                                details: false
                            }

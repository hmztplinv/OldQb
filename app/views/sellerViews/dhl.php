            ...
            <div class="inner-body">
                ...
                <div class="page-header">
                    <div>
                        ...
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index">DHL</a></li>
                    ...
                    <div class="col-md-12 col-lg-12 col-xl-12">
                        <div class="card custom-card transcation-crypto">
                            <div class="card-header custom-card-header">
                                <h5 class="main-content-label tx-dark my-auto fw-bold tx-medium mb-0">DHL Status İnquiry</h5>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row row-sm">
                                    <form action="<?=seller_url('dhl')?>" method="post">
                                        <div class="input-group-rounded ">
                                            <input required type="text" placeholder="Enter the 10-digit code"
                                                   name="dhlnumber" value="" class="btn-lg mt-4 w-30 responsive"
                                ...
                                <div class="row row-sm p-4">
                                    <div class="col-lg-2">
                                        <div class="mg-b-20">
                                            <select id="customerNameSearch" title="Customer Name" name="customerNameSearch" class="selectpicker">
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-lg-2">
                                                ...
                                                <tr>
                                                    <td class="sorting_1">
                                                                <span class="crypto-icon bg-primary-transparent me-3 my-auto">
                                                                    <a href="<?=site_url('seller/dhl_detail?dhlnumber='.$alldhl['dhlNumber'])?>">

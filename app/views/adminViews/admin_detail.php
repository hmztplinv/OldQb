            ...
            <div class="inner-body">
                ...
                <div class="row row-sm">
                    <div class="col-md-12 col-lg-12 col-xl-12">
                        <form action="<?= !isset($admin) ? admin_url('admin_detail') : ''  ?>" method="POST">
                        <div class="card custom-card transcation-crypto">
                            ...
                            <div class="card-body">
                                <div class="row row-sm">
                                    <div class="col-lg-6">
                                        <div class="mg-b-20">
                                            <p class="mg-b-0 text-primary fw-bold">Name & Surname</p>
                                            <input class="form-control input-lg" id="name" value="<?php
                                            if(isset($admin)){
                                                echo $admin['uname'].'" disabled ';
                                            }
                                            ?>"
                                                   name="name" type="text">
                                        </div>

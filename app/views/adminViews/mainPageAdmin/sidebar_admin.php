...
<div class="main-header side-header sticky">
    <div class="main-container container-fluid">
        <div class="main-header-left">
            ...
            <div class="hor-logo">
                <a class="main-logo" href="<?=site_url('admin/index')?>">
        ...
        <div class="main-header-center">
            <div class="responsive-logo">
                <a href="<?=site_url('admin/index')?>"><img src="<?=public_url('images/brand/qbdigitals.png')?>" height="50px"
                                          class="mobile-logo" alt="logo"></a>
                <a href="<?=site_url('admin/index')?>"><img src="<?=public_url('images/brand/logow.png')?>" height="50px"
                    ...
                    <div class="d-flex order-lg-2 ms-auto">
                        ...
                        <div class="dropdown main-profile-menu">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item border-top" href="<?=admin_url('admin_detail')?>">
                    ...
                    <li class="nav-item">
                        <a class="nav-link with-sub" href="javascript:void(0)">
                            ...
                            <span class="sidemenu-label">
                                <span class="sidemenu-label2">Products</span>
                            </span>
                        ...
                        <ul class="nav-sub">
                            ...
                            <li class="nav-sub-item">
                                <a class="nav-sub-link" href="<?=admin_url('products_qua')?>">QUA Products</a>
                            </li>
                            <li class="nav-sub-item">
                                <a class="nav-sub-link" href="<?=admin_url('products_bien?page=1')?>">BİEN Products</a>
                            </li>
                        </ul>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="<?=site_url('admin/tape_program')?>">
                            <span class="shape1"></span>
                            <span class="shape2"></span>
                            <i class="ti-pencil-alt sidemenu-icon menu-icon"></i>
                            <span class="sidemenu-label">Production Program</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?=site_url('admin/ports')?>">
                            <span class="shape1"></span>
                            <span class="shape2"></span>
                            <i class="ti-truck sidemenu-icon menu-icon"></i>
                            <span class="sidemenu-label">Ports</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link with-sub" href="javascript:void(0)">
                            ...
                            <span class="sidemenu-label">
                                <span class="sidemenu-label2">User Managment</span>
                            </span>
                            <i class="angle fe fe-chevron-right"></i>
                        </a>
                        <ul class="nav-sub">
                            ...
                            <li class="nav-sub-item">
                                <a class="nav-sub-link" href="<?=admin_url('user_operation')?>">Operation Managment</a>
                            </li>
                            <li class="nav-sub-item">
                                <a class="nav-sub-link" href="<?=admin_url('user_seller')?>">Seller Managment</a>
                            </li>
                        </ul>
                    </li>
                </ul>

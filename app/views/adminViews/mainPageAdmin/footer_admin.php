...
<div class="main-footer text-center">
    <div class="container">
        <div class="row row-sm">
            <div class="col-md-12">
						<span>Copyright © 2024<a href="https://www.qtech.com.tr/tr/">QTech</a>. Tüm hakları
							saklıdır.</span>
            </div>
        </div>
    </div>
...
<script src="<?=public_url('plugins/jquery.flot/jquery.flot.js')?>"></script>
<script src="<?=public_url('plugins/jquery.flot/jquery.flot.pie.js')?>"></script>
<script src="<?=public_url('plugins/jquery.flot/jquery.flot.resize.js')?>"></script>
<script src="<?=public_url('js/chart.flot.js')?>"></script>
...
<script src="<?=public_url('js/table-data.js')?>"></script>
...
<!-- Sidemenu js -->
<script src="<?=public_url('plugins/sidemenu/sidemenu.js')?>" id="leftmenu"></script>
...
<!-- Internal Dashboard js-->
<script src="<?=public_url('js/ecommerce-dashboard.js')?>"></script>

                ...
                <div class="col-md-3 col-lg-3 col-xl-3">
                    <div class="card custom-card">
                        ...
                        <div class="card-body">
                            ...
                            <a class="btn ripple btn-primary btn-block" href="<?= site_url('admin/overdue?page=').($selectpage) ?>">Reset</a>
                        </div>
                    </div>
                </div>

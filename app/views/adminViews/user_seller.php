    ...
    <div class="main-container container-fluid">
        <div class="inner-body">
            ...
            <div class="page-header">
                <div>
                    <h2 class="main-content-title tx-24 mg-b-5">Sellers</h2>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">User Managment</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Seller Managment</li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-md-12 col-lg-12 col-xl-12">
                    <div class="card custom-card transcation-crypto">
                        <div class="card-header custom-card-header">
                            <h5 class="main-content-label tx-dark my-auto fw-bold tx-medium mb-0">All Seller
                            </h5>
                                ...
                                <table id="example" class="display" style="width:100%">
                                    ...
                                    <?php foreach ($sellers as $item):?>
                                        <tr>
                                            ...
                                            <td align="center"><?=$item['sellerName']?></td>
                                            <td align="center"><?=$item['email']?></td>
                                            <td align="center"><?=$item['countryName']?></td>
                                            <form action="<?= site_url('admin/user_seller')?>" method="post">
                                            <td align="center"><button type="submit" class="btn btn-danger" name="deletecountry" value="<?=$item['sellerid']?>">Delete</button></td>
                                            </form>
            ...
            <div class="row row-sm">
                <div class="col-md-12 col-lg-12 col-xl-12">
                    <div class="card custom-card transcation-crypto">
                        <div class="card-header custom-card-header">
                            <h5 class="main-content-label tx-dark my-auto fw-bold tx-medium mb-0">Create New Seller
                            </h5>
                            <div class="card-options">
                                <a href="#" class="card-options-collapse" data-bs-toggle="card-collapse"><i
                                        class="fe fe-chevron-up"></i></a>
            ...
            <div class="row row-sm">
                <div class="col-md-12 col-lg-12 col-xl-12">
                    <div class="card custom-card transcation-crypto">
                        <div class="card-header custom-card-header">
                            <h5 class="main-content-label tx-dark my-auto fw-bold tx-medium mb-0">Country entry to Seller
                            </h5>
                            <div class="card-options">
                                <a href="#" class="card-options-collapse" data-bs-toggle="card-collapse"><i
                                        class="fe fe-chevron-up"></i></a>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <select class="form-control" name="user" id="exampleFormControlSelect1">
                                            <?php foreach ($sellersuser as $item): ?>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <select id="multipleSelect" name="country[]" multiple="multiple" class="mul-select">
                                            <?php foreach ($sellercountry as $item): ?>

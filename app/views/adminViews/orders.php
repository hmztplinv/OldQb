                ...
                <div class="row mt-3">
                        ...
                        <div class="card">
                            ...
                            <div class="p-5 mt-5">
                                <ul class="nav nav-tabs ">
                                    <a class="nav-link  active  " aria-current="page" href="orders"><p class="text-dark"><b>Orders</b></p></a>
                                    <li class="nav-item">
                                ...
                                <div style="    border: 1px;
                                    ...
                                    <div class="col-sm-3   ">
                                        ...
                                        <select id="orderCompanySearch" title="Company Name" class="selectpicker form-control" data-live-search=true name="orderCompanySearch">

                                        </select>
                                    </div>
                                    <div class="col-sm-3 mb-2">

                                        <select data-live-search=true  title="Size" class="selectpicker form-control" name="" id="orderSizeSearch">

                                        </select>
                                    </div>
                                    <div class="col-sm-3 mb-2">

                                        <select data-live-search=true title="  Surface" class="selectpicker form-control" name="" id="orderSurfaceSearch">
                                        </select>
                                    </div>
                                    <div class="col-sm-6 mb-8">
                                        <button style="margin-top:27px" onclick="reset()" type="submit" name="insertproductform" class="btn btn-outline-secondary btn-sm"><b>Reset</b></button>
                                    </div>
                                </div>
                                    ...
                                    <table id="example" class="display" style="width:100%">
                                        ...
                                        <?php foreach($approvedorders as $approvedorder):?>
                                            <tr>
                                                ...
                                                <td align="center"><?=$approvedorder['pcUnit']==NULL?'no info':$approvedorder['pcUnit']?></td>
                    ...
                    <script>
                        ...
                        function reset(){
                            ...
                            $("#orderCompanySearch").val([]);//select option değerlerini sıfırlar
                            $("#orderSizeSearch").val([]);
